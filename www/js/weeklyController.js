...
function getActivitiesList() {
 ...
 $http({
		method: 'POST',
		url:'http://myschool-myfirstschool.rhcloud.com/rest/activity/getAllImagesAndDocsByStudent',
...
$scope.downLoadFile = function(activityId) {
    alert(activityId);
    var httpPath='http://myschool-myfirstschool.rhcloud.com/rest/activity/downloadFile?activityId='+activityId;
    // Use an arraybuffer
